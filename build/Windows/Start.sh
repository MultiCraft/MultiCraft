...
cmake ../../ \
	...
	-DMBEDCRYPTO_LIBRARY="$DEPS_ROOT/mbedtls/lib/libmbedcrypto.a" \
	-DMBEDTLS_LIBRARY="$DEPS_ROOT/mbedtls/lib/libmbedtls.a" \
	-DMBEDX509_LIBRARY="$DEPS_ROOT/mbedtls/lib/libmbedx509.a" \
	-DMBEDTLS_INCLUDE_DIR="$DEPS_ROOT/mbedtle/include" \
